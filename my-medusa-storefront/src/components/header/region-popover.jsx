...
const RegionPopover = () => {
  ...
  return (
    ...
    >
      <div>
        <Menu.Button className="inline-flex justify-center w-full px-4 py-2 bg-white text-lg font-medium text-gray-700 hover:text-black">
                      ...
                      <button
                        ...
                        className={classNames(
                          country === country.display_name
                            ? "text-black"
                            : "text-ui-dark",
                          "block py-3 font-base text-lgw-full text-left hover:text-black"
                        )}
                      >
