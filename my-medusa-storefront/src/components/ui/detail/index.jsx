...
export default ({ title, index, children, open = false }) => {
  return (
    <details className="group shadow-xl rounded-xl overflow-hidden mb-6 pb-6" open={open}>
      <summary className=" pr-4 bg-black h-[50px] flex items-center justify-between text-white flex cursor-pointer select-none text-left leading-7">
        <div className="flex h-full items-center">
          <span
            ...
            after:border-l-[color:var(--fourth-color)]">{ index }</span>
