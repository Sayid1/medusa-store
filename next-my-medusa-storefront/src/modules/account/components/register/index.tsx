...
const Register = () => {
  ...
  return (
    <div className="max-w-sm flex flex-col items-center">
      <h1 className="text-4xl uppercase mb-6">Become a DOMOJT Member</h1>
      <p className="text-center text-xl text-gray-700 mb-4">
        Create your DOMOJT Member profile, and get access to an enhanced
        shopping experience.
      </p>
      <form className="w-full flex flex-col" onSubmit={onSubmit}>
        ...
        {authError && (
          <div>
            <span className="text-rose-500 w-full text-lg">
              These credentials do not match our records
            </span>
          </div>
        )}
        <span className="text-center text-gray-700 text-lg mt-6">
          By creating an account, you agree to DOMOJT&apos;s{" "}
