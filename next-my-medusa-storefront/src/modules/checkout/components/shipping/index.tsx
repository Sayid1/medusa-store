...
const Shipping: React.FC<ShippingProps> = ({ cart }) => {
  ...
  const handleChange = (
    ...
    submitShippingOption(value, setError)
    fn(value)
  }
  ...
  return (
    ...
    >
      <ConnectForm<CheckoutFormValues>>
        {({ control, setError, formState: { errors } }) => (
          <Controller
            name="soId"
            control={control}
                ...
                <div>
                  <RadioGroup
                    ...
                    onChange={(value: string) =>
                      handleChange(value, onChange, setError)
                    }
                  >
                      ...
                      shippingMethods.map((option) => {
                        return (
                          <RadioGroup.Option
                            ...
                            value={option.value}
                            className={clsx(
                              "flex items-center justify-between text-lg cursor-pointer py-4 border-b border-gray-200 last:border-b-0 pr-8 pl-10",
                              {
                                " bg-gradient-radial from-[#e61a5e] to-[#5e1ae6] text-white":
                                  option.value === value,
                              }
                            )}
                          >
                            ...
                            <span
                              className={clsx(
                                "justify-self-end font-DIN text-gray-700",
