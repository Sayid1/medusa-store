          ...
          <div className="mx-auto max-w-[60rem] leading-6 prose-sm prose prose-slate prose-a:font-semibold prose-a:text-sky-500 hover:prose-a:text-sky-600">
            ...
            <section>
              <div className="mt-12 text-gray-600 text-lg">
                ...
                <p className="mt-3">
                  This website is operated by 公司名称. Throughout the site, the
                  terms &quot;we&quot;, &quot;us&quot; and &quot;our&quot; refer
                  to 公司名称. 公司名称 offers this website, including all
                ...
                <h1 className="my-4 text-gray-900">
                ...
                <h1 className="my-4">SECTION 2 - GENERAL CONDITIONS</h1>{" "}
                <p>
                ...
                <p>
                  ...
                  <Link href="/domojt/refund-policy">
                    <a className="underline">RETURN POLICY</a>
                  </Link>
                </p>{" "}
                <p className="mt-3">
                ...
                <p>
                  In no case shall 公司名称, our directors, officers, employees,
                ...
                <p>
                  You agree to indemnify, defend and hold harmless 公司名称 and
                ...
                <h1 className="my-4 text-gray-900">SECTION 16 - TERMINATION</h1>{" "}
                <p>
                ...
                [INSERT TRADING NAME] [INSERT EMAIL ADDRESS] [INSERT BUSINESS
                ADDRESS] [INSERT BUSINESS PHONE NUMBER] [INSERT BUSINESS
...
TermsService.getLayout = (page: ReactElement) => {
